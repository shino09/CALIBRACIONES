            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Actualizar información marca equipo de pesaje</h3>
                    </div>
                    {!!Form::model($marca,['route' => ['marca.update',$marca -> id],'method' => 'PUT'])!!}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                {!!Form::label('tipoEquipo_id','Tipo de equipo',['class' => 'col-md-4 control-label'])!!}
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn btn-danger col-md-offset-4"><a href="{!! URL::to('/condicion') !!}" style="color: #ffffff">Atrás</a></button>
